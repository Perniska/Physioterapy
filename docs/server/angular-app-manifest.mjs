...
export default {
  ...
  assets: {
    ...
    'index.server.html': {size: 1281, hash: 'b8cdfeeac587951a76006a7bbd7774f68e4d67d243788ad43e2d8e9899e9731f', text: () => import('./assets-chunks/index_server_html.mjs').then(m => m.default)},
